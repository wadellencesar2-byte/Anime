...
const CONVERSAS_BASE = [
  ...
  { keywords: ["oi", "eae", "e ai", "bom dia", "boa tarde", "boa noite", "fala", "opa"],
    responses: ["Opa! Como posso ajudar por aqui?", "Fala comigo! Em que posso ajudar hoje?", "E aí! Pronto pra ajudar no que precisar.", "Oi! Tudo certo por aqui, me conta o que você precisa.", "Salve! Bora conversar, no que posso ser útil?"] },
  { keywords: ["tudo bem", "como voce esta", "de boa", "tudo certo", "tudo tranquilo"],
    responses: ["Por aqui tudo certo! E com você, como estão as coisas?", "Tudo tranquilo! Curioso pra saber, e você, como está?", "Tudo em ordem por aqui. Me conta como você está hoje."] },
  { keywords: ["obrigado", "valeu", "brigado", "agradeco", "gratidao"],
  ...
  { keywords: ["tchau", "ate mais", "falou", "ate logo", "ate a proxima", "vou nessa", "vou indo"],
    responses: ["Falou! Até a próxima conversa.", "Até mais! Volta sempre que precisar.", "Beleza, até logo! Foi bom conversar."] },
  { keywords: ["gosto de conversar com voce", "adorei essa conversa", "que papo bom"],
    responses: ["Eu também estou gostando dessa conversa! Pode perguntar mais o que quiser."] },

  // ---------- Sobre a IA ----------
  { keywords: ["quem e voce", "quem te criou", "quem te fez", "quem criou voce"],
  ...
  { keywords: ["o que voce sabe fazer", "o que voce faz", "suas funcoes", "no que voce ajuda", "pra que voce serve"],
  ...
  { keywords: ["voce e um robo", "voce e real", "voce e humano", "voce e uma ia", "voce pensa mesmo", "voce e inteligencia artificial"],
  ...
  { keywords: ["voce e inteligente", "gostei de voce", "voce e legal", "voce e bom", "muito bom isso", "ficou show", "ficou legal"],
  ...
  { keywords: ["voce e burro", "voce e ruim", "chat ruim", "voce nao presta", "que porcaria", "voce e chato"],
  ...
  { keywords: ["quantos anos voce tem", "sua idade"], responses: ["Não tenho idade no sentido humano — fui escrito recentemente, em JavaScript."] },
